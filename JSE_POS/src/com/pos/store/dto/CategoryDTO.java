...
public class CategoryDTO {
    ...
    private int parentCategortCode ; 
    ...
    public int getParentCategortCode() {
        return parentCategortCode;
    }

    public void setParentCategortCode(int parentCategortCode) {
        this.parentCategortCode = parentCategortCode;
    }
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + Objects.hashCode(this.parentCategortCode);
        return hash;
    }
    ...
    public String toString() {
        return "CategoryDTO{" + "id=" + id + ", bar_code=" + bar_code + ", nameAr=" + nameAr + ", nameEn=" + nameEn + ", description=" + description + ", discount=" + discount + ", printerAddress=" + printerAddress + ", parentCategortCode=" + parentCategortCode + '}';
    }
