...
//        }
    ...
    private void jButtonUpdateCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateCatActionPerformed
        ...
        try {
            ...
            if (isOk == true) {
                categoryBuss.save(theCategiry);
                JOptionPane.showMessageDialog(this, "The Category Field with the Code  " + theCategiry.getId() + "  has been Updated Successfully ");
            } else {
                JOptionPane.showMessageDialog(this, "The Updating Process Not Complete  ! \nTry Agin, With Fields Are Full . ", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void jButtonDeleteCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteCatActionPerformed
        ...
        try {
            ...
            if (isOk == true) {
                ...
                JOptionPane.showMessageDialog(this, "The Deleting Process Not Complete  ! \nTry Agin, With Fields Are Full . " ,"Error", JOptionPane.ERROR_MESSAGE);
            }
